...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        device_imageV = [[UIImageView alloc]initWithFrame:CGRectMake(5, 5, 53, 53)];
        ...
        macAddress_label = [[UILabel alloc]initWithFrame:CGRectMake(64, 37, 139, 21)];
        ...
        status_imageV = [[UIImageView alloc]initWithFrame:CGRectMake(265, 10, 44, 44)];
        status_imageV.image = self.status_image;
        status_imageV.tag = kStatusImageValueTag;
        [self.contentView addSubview:status_imageV];
                
        self.backgroundView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"tableviewcell_background_nor"]];
...
- (void)setStatus_image:(UIImage *)s
{
    ...
    {
        status_image = [s copy];
        UIImageView * status_imageV1 = (UIImageView *)[self.contentView viewWithTag:kStatusImageValueTag];
...
- (void)setName:(NSString *)n
{
    ...
    {
        name = [n copy];
        UILabel * name_label1 = (UILabel *)[self.contentView viewWithTag:kNameValueTag];
...
- (void)setMacAddress:(NSString *)m
{
    ...
    {
        macAddress = [m copy];
        UILabel * macAddress_label1 = (UILabel *)[self.contentView viewWithTag:kMacAddressValueTag];
...
- (void)setDevices_image:(UIImage *)d
{
    if (![d isEqual:devices_image])
    {
        ...
        UIImageView * devices_imageV1 = (UIImageView *)[self.contentView viewWithTag:kDeviceImageValueTag];
