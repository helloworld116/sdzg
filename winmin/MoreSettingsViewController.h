...
@interface MoreSettingsViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate,UIActionSheetDelegate,GCDAsyncUdpSocketDelegate,GCDAsyncSocketDelegate>
{
