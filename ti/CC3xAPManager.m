...
//                    LogInfo(@"subnet mask == %@",[NSString stringWithUTF8String:inet_ntoa(((struct sockaddr_in *)temp_addr->ifa_netmask)->sin_addr)]);
//                    
//                    LogInfo(@"dest mask == %@",[NSString stringWithUTF8String:inet_ntoa(((struct sockaddr_in *)temp_addr->ifa_dstaddr)->sin_addr)]);
                }
            }
...
- (NSString*)ssidForConnectedNetwork{
    ...
    LogInfo(@"SSID == %@  info === %@",[info objectForKey:@"SSID"],info);
