...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UINavigationController * device_nc = [[UINavigationController alloc]initWithRootViewController:device_c];

    device_c = nil;
    device_nc.tabBarItem.image = [UIImage imageNamed:@"tabbar_smartplug_sel"];
    device_nc.tabBarItem.title = @"设备";
    
    MoreSettingsViewController * more_c = [[MoreSettingsViewController alloc]init];
    UINavigationController * more_nc = [[UINavigationController alloc]initWithRootViewController:more_c];
    ...
    UIImage *backgroundImage = [UIImage imageNamed:@"navigation_background"];  //获取图片
